...
We start constructing predictive models to gain valuable insights into heart disease diagnosis. This section is subdivided into three core components: Scaling, Logistic Regression, and K-Nearest Neighbour.

2.4. Scaling

Scaling plays a major role in ensuring the accuracy and effectiveness of the k-Nearest Neighbours (kNN) algorithm in this project. Specifically, z-score standardization is employed to prepare the dataset for kNN classification.
